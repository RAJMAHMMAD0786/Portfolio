  ...
  return (
    <div className="homepage h-[85vh] bg-slate-950 flex max-[750px]:h-[85vh]">
      ...
      <div className="leftpart w-[50%]  pt-19 pl-10 flex flex-col gap-2 max-[750px]:pt-10 max-[750px]:pl-5">
        ...
        <div className="Aim">
          <h2 className="text-white text-xl max-[750px]:text-sm max-[750px]:pt-3">B.Tech CSE Student | Aspiring <span className="text-blue-500 text-xl max-[750px]:text-md">Full-Stack Developer</span></h2>
        </div>
        ...
        <div className="connect">
          <h3 className="text-white pt-11 font-bold max-[750px]:pt-1 max-[750px]:text-md">Connect With Me</h3>

          <div className="flex gap-7 mt-4 pl-10 max-[750px]:gap-5 max-[750px]:mt-0">
      ...
      <div className="rightpart pl-80 pt-15 max-[750px]:pl-5 max-[750px]:pr-0 max-[750px]:pt-10">
        ...
        <div className="codechefinfo">
          ...
          <div className="codechefbox flex justify-center items-center gap-3 w-auto h-16 bg-[#07111F] border border-[#16202f] rounded-xl mt-5 max-[750px]:text-7px max-[750px]:w-35 max-[750px]:mt-1 max-[750px]:h-10">

            <div className="problemsolve text-gray-500 flex flex-col items-center">
              <p className="font-bold max-[750px]:text-[10px]">750+</p>
              <p className="font-bold text-[11px] max-[750px]:text-[6px] max-[750px]:pl-1 ">Problem Solve</p>
            </div>

            <div className="contests text-gray-500 flex flex-col items-center">
              <p className="font-bold max-[750px]:text-[10px]">8+</p>
              <p className="font-bold text-[11px] max-[750px]:text-[6px] max-[750px]:pl-1 ">Contests Participated</p>
            </div>

            <div className="consistency text-gray-500 flex flex-col items-center">
              <p className="font-bold max-[750px]:text-[10px]">50+</p>
              <p className="font-bold text-[11px] max-[750px]:text-[6px] max-[750px]:pl-1 ">Days of Consistency</p>
            </div>
