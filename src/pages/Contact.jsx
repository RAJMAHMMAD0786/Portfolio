    ...
    <div className="Contactpage h-[85vh] bg-slate-950 max-[750px]:h-[85vh] flex">
      ...
      <div className="leftparts w-1/2 pl-20 pt-5 max-[750px]:pl-10">
        ...
        <div className="GetInTouch">
          <h1 className="text-white text-4xl flex items-center gap-3 max-[750px]:text-sm"> <TfiEmail className="text-blue-500 bg-[#06152B] rounded-md border border-blue-500 px-2 py-2 text-4xl max-[750px]:text-2xl" /> Get <span className="text-blue-500">In Touch</span></h1>
        </div>
        ...
        <div className="paragraph">
          <p className="text-white pt-3 text-md max-[750px]:text-xs">I'm a Frontend Developer passionate about creating responsive and user-friendly web applications. I'm currently looking for internship and entry-level opportunities. Whether you have a project, collaboration, or job opportunity, feel free to send me a message. I'll get back to you as soon as possible.</p>
        </div>

        {/* email  */}
        <div className="Email flex gap-3 items-center pt-3 max-[750px]:pt-1">
          {/* logo of the Email */}
          <div className="Emaillogo">
            <TfiEmail className="text-blue-500 bg-[#06152B] rounded-md border border-blue-500 px-2 py-2 text-4xl max-[750px]:text-2xl" />
          </div>

          {/* Contant of the Email */}
          <div className="content">
            <p className="text-white max-[750px]:text-sm">Email</p>
        ...
        {/* Phone  */}
        <div className="Phone flex gap-3 items-center pt-3 max-[750px]:pt-1">
          {/* logo of the Phone */}
          <div className="Phonelogo">
            <FaPhoneAlt className="text-blue-500 bg-[#06152B] rounded-md border border-blue-500 px-2 py-2 text-4xl max-[750px]:text-2xl" />
          </div>

          {/* Contant of the Phone */}
          <div className="content">
            <p className="text-white max-[750px]:text-sm">Phone</p>
        ...
        {/* Location  */}
        <div className="Location flex gap-3 items-center pt-3 max-[750px]:pt-1">
          {/* logo of the Location */}
          <div className="Locationlogo">
            <CiLocationOn className="text-blue-500 bg-[#06152B] rounded-md border border-blue-500 px-2 py-2 text-4xl max-[750px]:text-2xl" />
          </div>

          {/* Contant of the Location */}
          <div className="content">
            <p className="text-white max-[750px]:text-sm">Location</p>
        ...
        {/* LinkedIn  */}
        <div className="LinkedIn flex gap-3 items-center pt-3 max-[750px]:pt-1">
          {/* logo of the LinkedIn */}
          <div className="LinkedInlogo">
            <FaLinkedin className="text-blue-500 bg-[#06152B] rounded-md border border-blue-500 px-2 py-2 text-4xl max-[750px]:text-2xl" />
          </div>

          {/* Contant of the LinkedIn */}
          <div className="content">
            <p className="text-white max-[750px]:text-sm">LinkedIn</p>
            <span onClick={() =>
        ...
        {/* GitHub  */}
        <div className="GitHub flex gap-3 items-center pt-3 max-[750px]:pt-1">
          {/* logo of the GitHub */}
          <div className="GitHublogo">
            <FaGithub className="text-blue-500 bg-[#06152B] rounded-md border border-blue-500 px-2 py-2 text-4xl max-[750px]:text-2xl" />
          </div>

          {/* Contant of the GitHub */}
          <div className="content">
            <p className="text-white max-[750px]:text-sm">GitHub</p>
            <span onClick={() =>
